...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is UUA_Category
                   DESC

  s.homepage     = "https://github.com/willokyes/UUA_Category"
  ...
  s.source       = { :git => "https://github.com/willokyes/UUA_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "UUA_Category/UUA_Category/**/*.{h,m,swift}"
